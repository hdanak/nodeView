...
NodeView.Node       = NodeView.Class({
    mixins: [ NodeView.Graphic ],
    init: function ()
    {
...
/* I/O Pin Tray */
NodeView.PinTray    = NodeView.Class({
    init: function (type)
    {
        this.type = type;
    },
...
/* Directional Wire */
NodeView.Wire       = NodeView.Class({
    mixins: [ NodeView.Graphic, NodeView.Signals ],
