...
with(NodeView) {
  ...
  NodeView.Edge = MOP.Class({
    init: function(start, end, reverse)
    {
  ...
  NodeView.Modal = MOP.Class({
    init: function(eventSrc, eventCallback)
    {
      this._mode = "NORMAL"
